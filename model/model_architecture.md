# Lung Disease Detection AI - Model Architecture

This file is a human-readable representation of the binary `lung_model.h5` file.
...
| :--- | :--- | :--- | :--- | :--- |
| 0 | mobilenetv2_1.00_224 | Functional | (None, 7, 7, 1280) | 2,257,984 |
| 1 | global_average_pooling2d | GlobalAveragePooling2D | (None, 1280) | 0 |
| 2 | dense | Dense | (None, 512) | 655,872 |
| 3 | batch_normalization | BatchNormalization | (None, 512) | 2,048 |
| 4 | dropout | Dropout | (None, 512) | 0 |
| 5 | dense_1 | Dense | (None, 128) | 65,664 |
| 6 | dropout_1 | Dropout | (None, 128) | 0 |
| 7 | dense_2 | Dense | (None, 1) | 129 |

**Total Trainable Parameters:** 2,584,129
